...
/**
 * idpf_qp_disable - disable queues associated with queue pair
 * @qs: queue set to disable
 * @qid: index of the queue pair to disable
 *
 * Return: 0 on success, -errno on failure.
 */
...
/**
 * idpf_qp_enable - enable queues associated with queue pair
 * @qs: queue set to enable
 * @qid: index of the queue pair to enable
 *
 * Return: 0 on success, -errno on failure.
 */
